...
curl -L https://raw.githubusercontent.com/Programmer-Dr/termux-youtube-dl/master/.ytdl.conf >"${YOUTUBEDL_CONFIG_FOLDER}/config"
curl -L https://raw.githubusercontent.com/Programmer-Dr/termux-youtube-dl/master/sponsorblock.conf >"${YOUTUBEDL_CONFIG_FOLDER}/sponsorblock.conf"
curl -L https://raw.githubusercontent.com/Programmer-Dr/termux-youtube-dl/master/share2youtubedl.sh >"${TERMUXURLOPENER_CONFIG_FOLDER}/termux-url-opener"
